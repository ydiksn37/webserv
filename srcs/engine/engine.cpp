...
namespace {
	...
	void	applyErrorPage(HttpResponse &response, int code, const LocationContext *location, const ServerContext *server) {
	...
	HttpResponse	buildMethodNotAllowedResponse(const LocationContext &location) {
	...
	bool	prepareResponse(const HttpRequest &request, const RouteContext &route, HttpResponse &response) {
	...
	std::string translatePath(const HttpRequest &request, const LocationContext &location, const ServerContext &server) {
	...
	std::string resolveScriptPath(const HttpRequest &request, const LocationContext &location, const ServerContext &server) {
	...
	HttpResponse	handlePost(const HttpRequest &request, const ServerContext &server, const LocationContext &location) {
		HttpResponse response;
